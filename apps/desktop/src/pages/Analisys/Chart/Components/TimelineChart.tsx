...
import { useGoogleChartAutoHeight } from "@/pages/Analisys/Chart/Components/useGoogleChartAutoHeight.ts";
...
export const TimelineChart = ({chartData, options, onChartIsReady}: TimelineChartProps) => {
    const {chartContainerRef, chartHeight, chartEvents, chartIsReady} = useGoogleChartAutoHeight(chartData);
