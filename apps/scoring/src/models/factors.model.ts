...
const FactorsSchema = new mongoose.Schema<FactorsDocumentType, FactorsModelType>({
...
export const FactorsModel = mongoose.model<FactorsDocumentType, FactorsModelType>('Factors', FactorsSchema);
